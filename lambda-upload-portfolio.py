...
def lambda_handler(event, context):
    ...
    try:
        ...
        portfolio_bucket = s3.Bucket('portfolio.xbcw.net')
        ...
        send_notification('arn:aws:sns:us-east-1:092288055581:PortfolioNotify', 'Successful portfolio.xbcw.net Deployment', message)
        print message
    except:
        if job:
        ...
        send_notification('arn:aws:sns:us-east-1:092288055581:PortfolioNotify', 'Failed portfolio.xbcw.net Deployment', message)
        print message
        raise
